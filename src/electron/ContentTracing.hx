...
@:jsRequire("electron", "contentTracing") @:require("electron") extern class ContentTracing {
	...
	**/
	static function getCategories(callback:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	...
	var traceOptions : String; }, callback:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	static function stopRecording(resultFilePath:String, callback:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	static function stopMonitoring(callback:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	static function captureMonitoringSnapshot(resultFilePath:String, callback:haxe.Constraints.Function):Dynamic;
	/**
		Get the maximum usage across processes of trace buffer as a percentage of the full state. When the TraceBufferUsage value is determined the callback is called.
	**/
	static function getTraceBufferUsage(callback:haxe.Constraints.Function):Dynamic;
	/**
		callback will be called every time the given event occurs on any process.
	**/
	static function setWatchEvent(categoryName:String, eventName:String, callback:haxe.Constraints.Function):Dynamic;
	/**
		Cancel the watch event. This may lead to a race condition with the watch event callback if tracing is enabled.
	**/
	static function cancelWatchEvent():Dynamic;
}