package electron;
@:jsRequire("electron", "protocol") @:require("electron") extern class Protocol {
	/**
	...
	**/
	static function registerStandardSchemes(schemes:Array<String>):Dynamic;
	static function registerServiceWorkerSchemes(schemes:Array<String>):Dynamic;
	/**
	...
	**/
	static function registerFileProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	static function registerBufferProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	static function registerStringProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
	...
	**/
	static function registerHttpProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
		Unregisters the custom protocol of scheme.
	**/
	static function unregisterProtocol(scheme:String, ?completion:haxe.Constraints.Function):Dynamic;
	/**
		The callback will be called with a boolean that indicates whether there is already a handler for scheme.
	**/
	static function isProtocolHandled(scheme:String, callback:haxe.Constraints.Function):Dynamic;
	/**
		Intercepts scheme protocol and uses handler as the protocol's new handler which sends a file as a response.
	**/
	static function interceptFileProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
		Intercepts scheme protocol and uses handler as the protocol's new handler which sends a String as a response.
	**/
	static function interceptStringProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
		Intercepts scheme protocol and uses handler as the protocol's new handler which sends a Buffer as a response.
	**/
	static function interceptBufferProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
		Intercepts scheme protocol and uses handler as the protocol's new handler which sends a new HTTP request as a response.
	**/
	static function interceptHttpProtocol(scheme:String, handler:haxe.Constraints.Function, ?completion:haxe.Constraints.Function):Dynamic;
	/**
		Remove the interceptor installed for scheme and restore its original handler.
	**/
	static function uninterceptProtocol(scheme:String, completion:haxe.Constraints.Function):Dynamic;
}