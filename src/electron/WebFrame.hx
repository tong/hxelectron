...
@:jsRequire("electron", "webFrame") @:require("electron") extern class WebFrame {
	...
	**/
	static function setZoomFactor(factor:Float):Dynamic;
	static function getZoomFactor():Float;
	/**
		Changes the zoom level to the specified level. The original size is 0 and each increment above or below represents zooming 20% larger or smaller to default limits of 300% and 50% of original size, respectively.
	**/
	static function setZoomLevel(level:Float):Dynamic;
	static function getZoomLevel():Float;
	/**
		Sets the maximum and minimum zoom level.
	**/
	static function setZoomLevelLimits(minimumLevel:Float, maximumLevel:Float):Dynamic;
	/**
	...
	**/
	static function setSpellCheckProvider(language:String, autoCorrectWord:Bool, provider:Dynamic):Dynamic;
	/**
	...
	**/
	static function registerURLSchemeAsSecure(scheme:String):Dynamic;
	/**
		Resources will be loaded from this scheme regardless of the current page's Content Security Policy.
	**/
	static function registerURLSchemeAsBypassingCSP(scheme:String):Dynamic;
	/**
		Registers the scheme as secure, bypasses content security policy for resources, allows registering ServiceWorker and supports fetch API.
	**/
	static function registerURLSchemeAsPrivileged(scheme:String):Dynamic;
	/**
		Inserts text to the focused element.
	**/
	static function insertText(text:String):Dynamic;
	/**
	...
	**/
	static function executeJavaScript(code:String, userGesture:Bool):Dynamic;
	/**
	...
	**/
	...
	var images : electron.MemoryUsageDetails; @:optional
	var cssStyleSheets : electron.MemoryUsageDetails; @:optional
	var xslStyleSheets : electron.MemoryUsageDetails; @:optional
	var fonts : electron.MemoryUsageDetails; @:optional
	var other : electron.MemoryUsageDetails; };
	/**
	...
	**/
	static function clearCache():Dynamic;
}