...
/**
**/
@:require(js, electron) @:enum abstract IncomingMessageEvent<T:(haxe.Constraints.Function)>(js.node.events.EventEmitter.Event<T>) to js.node.events.EventEmitter.Event<T> {
	/**
		The data event is the usual method of transferring response data into applicative code.
	**/
	var data : electron.main.IncomingMessage.IncomingMessageEvent<js.node.Buffer -> Void> = "data";
	/**
		Indicates that response body has ended.
	**/
	var end : electron.main.IncomingMessage.IncomingMessageEvent<Void -> Void> = "end";
	/**
		Emitted when a request has been canceled during an ongoing HTTP transaction.
	**/
	var aborted : electron.main.IncomingMessage.IncomingMessageEvent<Void -> Void> = "aborted";
	/**
	...
	**/
	var error : electron.main.IncomingMessage.IncomingMessageEvent<Void -> Void> = "error";
}