...
@:enum abstract ThumbarButtosFlag(String) from String to String {
    var enabled = "enabled";
...
extern class BrowserWindow extends EventEmitter<BrowserWindow> {
    ...
    function setThumbarButtons( buttons : Array<{icon:NativeImage,?tooltip:String,?flags:Array<ThumbarButtosFlag>,click:Void->Void}> ) : Void;
