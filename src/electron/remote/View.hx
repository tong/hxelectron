...
**/
@:jsRequire("electron", "remote.View") extern class View extends js.node.events.EventEmitter<electron.remote.View> {
	/**
...
enum abstract ViewEvent<T:(haxe.Constraints.Function)>(js.node.events.EventEmitter.Event<T>) from js.node.events.EventEmitter.Event<T> {
	...
	**/
	var bounds_changed : electron.remote.ViewEvent<Void -> Void> = "bounds-changed";
}
