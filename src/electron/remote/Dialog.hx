...
@:jsRequire("electron", "remote.dialog") extern class Dialog extends js.node.events.EventEmitter<electron.remote.Dialog> {
	...
	**/
	static function showSaveDialogSync(?window:electron.remote.BaseWindow, options:{ /**
	...
	**/
	static function showSaveDialog(?window:electron.remote.BaseWindow, options:{ /**
		The dialog title. Cannot be displayed on some _Linux_ desktop environments.
	**/
	@:optional
	var title : String; /**
	...
	**/
	static function showMessageBoxSync(?window:electron.remote.BaseWindow, options:{ /**
	...
	**/
	...
	/**
		...
		* `checkboxChecked` boolean - The checked state of the checkbox if `checkboxLabel` was set. Otherwise `false`.
		...
		The `window` argument allows the dialog to attach itself to a parent window, making it modal.
	**/
	static function showMessageBox(?window:electron.remote.BaseWindow, options:{ /**
		Content of the message box.
	**/
	var message : String; /**
		Can be `none`, `info`, `error`, `question` or `warning`. On Windows, `question` displays the same icon as `info`, unless you set an icon using the `icon` option. On macOS, both `warning` and `error` display the same warning icon.
