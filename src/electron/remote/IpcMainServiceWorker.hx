...
**/
@:jsRequire("electron", "remote.IpcMainServiceWorker") extern class IpcMainServiceWorker extends js.node.events.EventEmitter<electron.remote.IpcMainServiceWorker> {
	/**
