...
enum abstract SessionEvent<T:(haxe.Constraints.Function)>(js.node.events.EventEmitter.Event<T>) from js.node.events.EventEmitter.Event<T> {
	...
	**/
	...
	var file_system_access_restricted : electron.remote.SessionEvent<Void -> Void> = "file-system-access-restricted";
	/**
	...
	**/
	var hid_device_added : electron.remote.SessionEvent<Void -> Void> = "hid-device-added";
	/**
	...
	**/
	var hid_device_removed : electron.remote.SessionEvent<Void -> Void> = "hid-device-removed";
	/**
	...
	**/
	var hid_device_revoked : electron.remote.SessionEvent<Void -> Void> = "hid-device-revoked";
	/**
